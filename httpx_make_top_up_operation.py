...
make_top_operation_response = httpx.post(
    'http://localhost:8003/api/v1/operations/make-top-up-operation',
    json=make_top_up_operation_payload
)
make_top_operation_response_data = make_top_operation_response.json()

print('Make top up operation response: ', make_top_operation_response_data)
print('Make top up operation status code: ', make_top_operation_response.status_code)
